...
namespace _20180628_SP.v1
{
    public partial class FrmSenadores : Form
    {
        ...
        public void ManejadorVoto(string senador, Votacion.EVoto voto)
        {
            ...
            {
                Votacion.DelegadoVoto recall = new Votacion.DelegadoVoto(this.ManejadorVoto);
            ...
            else
            {
                ...
                if (aux == 0)
                {
                    ...
                    // Guardar resultados
                   DAO sql = new DAO();
                    sql.Guardar("Server = .; Database = votacion-sp-2018; Trusted_Connection = true;", votacion);
                    SerializarXML<Votacion> xml = new SerializarXML<Votacion>();
                    xml.Guardar("votacion.xml", votacion);
                }
            }
        }
