...
namespace Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Equipo equipo= new Equipo("UTN"); // Genero un Director Técnico y lo asigno al equipo
            ...
            equipo = equipo + j2;
            equipo = equipo + j3;
            Console.WriteLine("*******************************EQUIPO INVÁLIDO*******************************"); // Imprimo los datos del equipo
            ...
            equipo = equipo + j7; 
            equipo = equipo + j8;
            Console.WriteLine("*******************************EQUIPO VÁLIDO*********************************"); // Imprimo los datos del equipo
            Console.WriteLine((string)equipo); 
            if(Equipo.ValidarEquipo(equipo)) 
                Console.WriteLine("El equipo es válido"); 
            else 
